const appName = 'Panel'
const appCacheName = 'Panel-1.4.4';

const preCacheFiles = [];

const cachePatterns = ['https://cdn.holoviz.org/panel/1.4.4/dist/', 'https://cdn.bokeh.org/bokeh/', 'https://cdn.jsdelivr.net/pyodide/', 'https://files.pythonhosted.org/packages/', 'https://pypi.org/pypi/'];
